...
namespace PongRoyale_client.Tests
{
    ...
    public class ArenaDimensionsTests
    {
        ...
        {
            ArenaDimensions arena = new ArenaDimensions(new PongRoyale_shared.Vector2(10, 10), new PongRoyale_shared.Vector2(0, 0), 10);
            Assert.IsTrue(arena.Size.Equals(new PongRoyale_shared.Vector2(10, 10)) && arena.Center.Equals(new PongRoyale_shared.Vector2(0, 0)) && arena.Radius == 10);
        }
